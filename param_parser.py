...
def parameter_parser():
    ...
    parser.add_argument('--model', default="BBGCN_1")
    parser.add_argument('--explain_mode', action='store_false', default=True,
                        help='Enable explain mode.')
    ...
    parser.add_argument("--n_layers", type=int, default=3,
                        help="Number of Graph Conv layers. Default is 3.")
    ...
    parser.add_argument('--network_type', nargs='?', default="DDI", choices=["DDI", "DTI", "PPI", "GDI", "ecoli"],
    ...
    parser.add_argument("--layers-1", nargs="+", type=int,
                        help="Layer dimensions separated by space (top). E.g. 200 200.")
    ...
    parser.add_argument("--truncation", type=int, default=10,
                        help="K: Truncation for variational approximation")
    parser.add_argument('--use-cuda', action='store_false',
                        help="Use CPU or GPU")
    parser.add_argument("--a-prior", type=float, default=1.1,
                        help="a parameter for Beta distribution")
    parser.add_argument("--b-prior", type=float, default=5,
